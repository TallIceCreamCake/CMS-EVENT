...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($_FILES['file']['name'])) {
        ...
        // Préparez la requête SQL pour l'insertion avec la colonne "pp" et "mail2"
        ...
        $reservation_query->bind_param("sssssiisisssssis", $nom, $prenom, $entreprise, $mail, $mail2, $numero, $numero2, $uniqueFilename, $type, $adressnumero, $adressstreet, $adresszipcode, $adresscity, $billingadress, $adresszipcode, $adresscity);
        } else {
        // Préparez la requête SQL pour l'insertion sans la colonne "pp" et "mail2"
        ...
        $reservation_query->bind_param("sssssiisisisiss", $nom, $prenom, $entreprise, $mail, $mail2, $numero, $numero2, $type, $adressnumero, $adressstreet, $adresszipcode, $adresscity, $billingadress, $adresszipcode, $adresscity);
    }
