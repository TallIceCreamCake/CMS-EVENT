                ...
                <nav
                    ...
                    <div class="flex w-full items-center px-6 pb-6 mb-6 lg:border-b border-gray-700">
                        <a class="text-xl text-white font-semibold" href="#" data-config-id="brand">
                            <img class="h-8" src="artemis-assets/logos/artemis-logo.svg" alt="" width="auto"> Audio Live
                        </a>
                    </div>
                    <div class="px-4 pb-6">
                        ...
                        <ul class="mb-8 text-sm font-medium">
                            ...
                            <li>
                                <a class="flex items-center pl-3 py-3 pr-4 text-gray-50 bg-indigo-500 rounded"
                ...
                <div class="grid md:grid-cols-2 md:gap-6 ml-[5rem] mr-[3rem]">
                    <div class="flex items-center mb-3">
                        <div class="relative z-0 w-full mb-5 group mr-[1rem]"><input
                                ...
                                type="text" id="searchPrestationInput" placeholder="Nom de l'entrepot"></div>
                    </div>
                </div>
            </div>
